...
import { ClaudeCodeConfig, DEFAULT_CLAUDE_CODE_SETTINGS } from "./claude-code/claudeCodeConfig";

export interface ModelConfig extends OpenAIConfig, GoogleConfig, AnthropicConfig, PerplexityConfig, MistralConfig, CohereConfig, OllamaConfig, ClaudeCodeConfig {
	provider: string;
}
